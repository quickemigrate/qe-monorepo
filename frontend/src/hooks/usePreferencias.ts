...
export const TEMAS: Record<TemaId, Tema> = {
  ...
  oceano: {
    ...
    main: '#eef6ff',
    preview: 'linear-gradient(135deg, #0c2340 50%, #eef6ff 50%)',
    logo: '/logo-dark.png',
  },
  bosque: {
    ...
    main: '#f0faf4',
    preview: 'linear-gradient(135deg, #14291e 50%, #f0faf4 50%)',
    logo: '/logo-dark.png',
  },
  aurora: {
    ...
    main: '#f5f3ff',
    preview: 'linear-gradient(135deg, #1e1246 50%, #f5f3ff 50%)',
    logo: '/logo-dark.png',
  },
  atardecer: {
    ...
    main: '#fff7ed',
    preview: 'linear-gradient(135deg, #6b1f0f 50%, #fff7ed 50%)',
    logo: '/logo-dark.png',
  },
  minimal: {

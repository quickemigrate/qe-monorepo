        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-x-12 gap-y-8">
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-2 text-on-background/60 font-medium">
              <a href="#" className="hover:text-primary-container transition-colors">Diagnóstico</a>
              <a href="#" className="hover:text-primary-container transition-colors">Estudios</a>
              <a href="#" className="hover:text-primary-container transition-colors">No Lucrativo</a>
            </div>
          </div>
          <div className="space-y-4">
            <h4 className="text-xs font-black uppercase tracking-widest text-on-background">Compañía</h4>
            <div className="flex flex-col gap-2 text-on-background/60 font-medium">
              <a href="#" className="hover:text-primary-container transition-colors">Sobre nosotros</a>
